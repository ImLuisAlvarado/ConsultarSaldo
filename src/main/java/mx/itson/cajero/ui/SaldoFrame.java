...
public class SaldoFrame extends javax.swing.JFrame {
     ...
     */
    public SaldoFrame(CuentaBancaria cuenta) {
        initComponents();
        //labels
        lblNombre.setText("Bienvenido "+cuenta.getTitular());
        lblSaldo.setText(cuenta.consultarSaldo());
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new SaldoFrame(cuenta).setVisible(true);
            }
        });
    }
